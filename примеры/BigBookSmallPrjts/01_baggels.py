...
def main():
    ...
    while True:
        ...
        while numGuesses <= MAX_GUESES:
            guess = ''
            # Keep looping until they enter a vakid guess:
...
def getClues(guess, secretNum):
    ...
    for i in range(len(guess)):
        if guess[i] == secretNum[i]:
            # A correct digits is in the correct place. 
            clues.append('Fermi')
    ...
    if len(clues) == 0:
        ...
        # Short clues into aplphabetical order so their original order
        # doesn't give information away. 
        clues.sort()
        # Make a single string from the list o string clues. 
        return ' '.join(clues)
