...
class Pan(games.Sprite):
	...
	def __init__(self):
		"""Инициализирует объект Pan и создает объект Text для 
		отображения счета. """
	...
	def update(self):
		"""передвигает объект по горизонтали в точку с абсциссойб
...
class Chef(games.Sprite):
	...
	def check_drop(self):
		...
		очередную пиццу и востанавливает исходный интервал. """
