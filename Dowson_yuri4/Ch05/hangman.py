...
# отгадать за отведенное число попыток, на экране появится фигурка повешенного.
# импорт модуля
import random
# константы
HANGMAN = (
...
while wrong < MAX_WRONG and so_far != word:
	print(HANGMAN[wrong])
	print("\nВы уже предагали следующие буквы:\n", used)
	print("\nОтгаданное вами в словк сейчас выглядит так:\n", so_far)
	guess = input("\n\nВведите букву: ")
	guess = guess.upper()
	while guess in used:
