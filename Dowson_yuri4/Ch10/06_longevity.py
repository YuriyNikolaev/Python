# filename 06_longevity.py
# Долгожитель
# Демонстрирует текстовое поле, текстовую область и менеджер размещений Grid
from tkinter import *
class Application(Frame):
	...
	def reveal(self):
		...
		if contents == "secret":
			...
			message = "Вы ввели не правильный пароль, так что я не могу" \
