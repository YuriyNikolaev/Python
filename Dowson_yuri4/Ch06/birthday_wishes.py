# filename birthday_wishes2.py
# День рождения
# Демонстрирует именованне аргументы и значения параметров по умолчанию

# позиционные параметры
def birthday1(name, age):
	print("С днем рождения, ", name, "!", " Вам сегодня исполняется", age, ", не так ли?\n")

# параметры со значение по умолчанию
def birthday2(name = "товарищ Иванов", age = 1):
	print("С днем рожения, ", name, "!", " Вам сегодня исполняется", age, ", не так ли?\n")
